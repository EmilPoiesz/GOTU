...
#python3 main.py -seed 1 -task threesym -model transformer -lr 0.00002 -epochs 3 -batch-size 256 -opt adam
...
python3 main.py -seed 1 -task maj3dim40freeze2 -model transformer -lr 0.00001 -epochs 5 -batch-size 256 -opt adam
